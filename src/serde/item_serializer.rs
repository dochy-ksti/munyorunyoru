...
// impl<'a> serde::ser::Serializer for &'a mut ItemSerializer {
//     type Ok = ();
...
// impl<'a> ser::SerializeSeq for &'a mut ItemSerializer {
//     type Ok = ();
...
// impl<'a> ser::SerializeTuple for &'a mut ItemSerializer {
//     type Ok = ();
...
// impl<'a> ser::SerializeTupleStruct for &'a mut ItemSerializer {
//     type Ok = ();
...
//     }
// }
// impl<'a> ser::SerializeTupleVariant for &'a mut ItemSerializer {
//     type Ok = ();
...
//     }
// }
// impl<'a> ser::SerializeMap for &'a mut ItemSerializer {
//     type Ok = ();
...
// impl<'a> ser::SerializeStructVariant for &'a mut ItemSerializer {
//     type Ok = ();
