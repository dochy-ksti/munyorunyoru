...
0  0   0  1  0  0...
```
The reality of what is called a word vector is an index of a word list, and AI performs completely different processing based on that index. I think this is essentially a match statement. So, in my definition, natural languages are languages, at least in the AI world.